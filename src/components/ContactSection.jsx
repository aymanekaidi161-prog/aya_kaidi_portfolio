...
const contactData = [
  {
    ...
    label: "Instagram",
    value: "@si.aya1",
    href: "https://www.instagram.com/si.aya1?igsh=MXd5em1jeHF4dXdnNQ==",
    external: true,
  },
  {
    icon: Linkedin,
    label: "LinkedIn",
    value: "Kaidi Aya",
    href: "https://www.linkedin.com/in/aya-kaidi-879294395?utm_source=share_via&utm_content=profile&utm_medium=member_android",
    external: true,
  },
  {
    icon: Facebook,
    label: "Facebook",
    value: "Kaidi Aya",
    href: "https://www.facebook.com/profile.php?id=100054382428134",
    external: true,
  },
  {
    icon: Phone,
    label: "Phone",
    value: "+212-772068589",
    href: "tel:+212772068589",
    external: false,
  },
  {
    icon: Mail,
    label: "Email",
    value: "ayakaidi205@gmail.com",
    href: "mailto:ayakaidi205@gmail.com",
    external: false,
  },
];
