        ...
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          <div className="hidden md:flex items-center gap-4">
            ...
            <a
              href="/cv.pdf"
              download
              className="px-6 py-2 bg-amber-900 text-white rounded-full font-medium hover:bg-amber-800 transition-all duration-300 shadow-md hover:scale-105 flex items-center gap-2"
            >
              <Download size={16} /> CV
            </a>
          </div>
